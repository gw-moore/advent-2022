...
def id_start_of_message_marker(buff: str):
    """Find the first 14 non-repeating character in a string and return the index at the start of the id"""
...
index, uid = id_start_of_message_marker(buff)
